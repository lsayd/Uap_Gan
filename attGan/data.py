...
class CelebA_HQ(data.Dataset):
    def __init__(self, data_path, attr_path, image_list_path, image_size, mode, selected_attrs):
        ...
        self.data_path = data_path
        attr_path=r'D:\lkq\UniversalPert_Gan\AttGAN/data/list_attr_celeba.txt'
        att_list = open(r'D:\lkq\UniversalPert_Gan\AttGAN/data/list_attr_celeba.txt', 'r', encoding='utf-8').readlines()[1].split()
        atts = [att_list.index(att) + 1 for att in selected_attrs]
        ...
        image_list_path=r'D:\lkq\UniversalPert_Gan\AttGAN/data/image_list.txt'
